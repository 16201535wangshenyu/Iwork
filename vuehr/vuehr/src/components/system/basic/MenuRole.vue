  ...
  <div>
    ...
    <div style="margin-top: 10px;text-align: left">
      <el-collapse v-model="activeColItem" accordion style="width: 500px;" @change="collapseChange">
        <el-collapse-item v-for="(item,index) in roles" :title="item.nameZh" :name="item.roleUid" :key="item.name">
  ...
  export default{
    ...
    methods: {
      ...
      updateRoleMenu(index){
        ...
        var _this = this;
        console.log("修改数据")
        console.log(this.activeColItem)
