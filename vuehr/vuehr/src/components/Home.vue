<template>
  <div>
    <el-container class="home-container">
      <el-header class="home-header">
        <span class="home_title">Iwork</span>
  ...
  <span class="el-dropdown-link home_userinfo" style="display: flex;align-items: center">
    {{user.realName}}
    <i><img v-if="user.userFace!=''" :src="user.userFace" class="menu-i"
            style="width: 40px;height: 40px;margin-right: 5px;margin-left: 5px;border-radius: 40px"/></i>
  </span>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="jump">个人中心</el-dropdown-item>
              <el-dropdown-item @click.native="changeColor">设置</el-dropdown-item>
    ...
    <el-dialog
      ...
      <el-row style="margin-bottom:10px;">
        <el-col :span="8">主题颜色</el-col>
        <el-col :span="8">图标颜色</el-col>
        <el-col :span="8">字体颜色</el-col>
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-color-picker v-model="themeColor" show-alpha></el-color-picker>
        </el-col>
        <el-col :span="8">
          <el-color-picker v-model="iconColor" show-alpha></el-color-picker>
        </el-col>
        <el-col :span="8">
...
//      this.devMsg();
    ...
    methods: {
      getTheme:function(){
        ...
        this.textColor=localStorage.getItem('text');
        this.iconColor=localStorage.getItem('icon');
        this.styleInner = `<style>.home-header{ background-color: ${this.themeColor};} .el-submenu__title i{color:${this.iconColor};} .el-submenu__title{color:${this.textColor};}</style>`
      },
      ...
      changeTheme:function(){
        ...
        localStorage.setItem('text',this.textColor);
        localStorage.setItem('icon',this.iconColor);
